...
export default function App() {
	const questions = [
		...
		{
			questionText: 'Who is the captain of Karachi Kings?',
			answerOptions: [
				{ answerText: 'Sarfaraz', isCorrect: false },
				{ answerText: 'Babar Azam', isCorrect: true },
				{ answerText: 'Shoaib Akhter', isCorrect: false },
				{ answerText: 'Imzimam ul Haq', isCorrect: false },
			],
		},
		{
